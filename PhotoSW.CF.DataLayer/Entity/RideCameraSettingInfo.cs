...
namespace PhotoSW.CF.DataLayer.Entity
    {
    [Table("RideCameraSettingInfo")]

    public class ridecamerasettinginfo
	{
        ...
        public string IrisAutoTarget { get; set; }

        public string LensPIrisFrequency { get; set; }

        public string LensPIrisNumSteps { get; set; }

        public string LensPIrisPosition { get; set; }

        public string ColorTransformationMode { get; set; }

        public string ColorTransformationValues { get; set; }
