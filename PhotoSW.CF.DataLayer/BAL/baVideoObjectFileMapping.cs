...
namespace PhotoSW.CF.DataLayer.BAL
    {
    public class baVideoObjectFileMapping
        {
        ...
        public static baVideoObjectFileMapping GetVideoObjectFileMappingDataById ( int Id )
            {
            try
                {
        ...
        public static List<baVideoObjectFileMapping> GetVideoObjectFileMappingData ()
            {
            try
                {
        ...
        public static bool Delete ( int Id )
            ...
            try
                ...
                using(PhotoSWEntities db = new PhotoSWEntities())
                    {
                    var obj = db.VideoObjectFileMappings.Where(p => p.Id == Id).FirstOrDefault();
                    if(obj != null)
                        {
                        obj.IsActive = false;
                        db.SaveChanges();
