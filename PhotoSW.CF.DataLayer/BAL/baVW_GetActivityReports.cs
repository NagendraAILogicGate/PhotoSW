...
namespace PhotoSW.CF.DataLayer.BAL
    {
    public class baVW_GetActivityReports
        {
        ...
        public static bool Marge ()
            ...
            try
                ...
                using(PhotoSWEntities db = new PhotoSWEntities())
                    ...
                    vw_getactivityreports.PS_User_Name = "Jay";
                    vw_getactivityreports.PS_User_First_Name = "Jay";
                    vw_getactivityreports.PS_User_Last_Name = "Shukla";
                    vw_getactivityreports.PS_Actions_pkey = 44;
        ...
        public static baVW_GetActivityReports GetPhotoGroupInfoDataById ( int Id )
            {
            try
                {
                ...
                using(PhotoSWEntities db = new PhotoSWEntities())
                    {
                    var obj = db.vw_GetActivityReportses.Where(p => p.Id == Id && p.IsActive == true).Select(p => new baVW_GetActivityReports
                        {
                        Id = p.Id,
        ...
        public static List<baVW_GetActivityReports> GetPhotoGroupInfoData ()
            {
            try
                {
                ...
                using(PhotoSWEntities db = new PhotoSWEntities())
                    {
                    var obj = db.vw_GetActivityReportses.Where(p => p.IsActive == true).Select(p => new baVW_GetActivityReports
                        {
                        Id = p.Id,
                        PS_Acitivity_Action_Pkey = p.PS_Acitivity_Action_Pkey,
                        PS_Acitivity_ActionType = p.PS_Acitivity_ActionType,
        ...
        public static bool Insert ( baVW_GetActivityReports baVW_GetActivityReports )
            {
            try
                {
                using(PhotoSWEntities db = new PhotoSWEntities())
        ...
        public static bool Update ( baVW_GetActivityReports baVW_GetActivityReports )
            {
            try
                {
                using(PhotoSWEntities db = new PhotoSWEntities())
