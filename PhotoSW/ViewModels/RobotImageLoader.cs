...
namespace PhotoSW.ViewModels
{
    public static class RobotImageLoader
    {
        ...
        private static System.Collections.Generic.List<LstMyItems> SelectPhotoByTimeAndQRCode(System.Collections.Generic.List<LstMyItems> temprobotImages,
            SearchDetailInfo Searchdetails, SearchCriteriaInfo SearchBiz, System.Collections.Generic.List<ModratePhotoInfo> moderatePhotosList)
        {
        ...
        private static void SelectPhotoByRFID(System.Collections.Generic.List<LstMyItems> temprobotImages, System.Collections.Generic.List<ModratePhotoInfo> moderatePhotosList, PhotoBusiness phBiz)
        {
            ...
            source = (from t in phBiz.GetAllPhotosforSearch(LoginUser.DefaultSubstores, System.Convert.ToInt64(RobotImageLoader.RFID), num, LoginUser.IsPhotographerSerailSearchActive, RobotImageLoader.StartIndexRFID, RobotImageLoader._rfidSearch, RobotImageLoader.NewRecord, out RobotImageLoader.MaxPhotoIdCriteria, out RobotImageLoader.MinPhotoIdCriteria, RobotImageLoader.MediaTypes)
        ...
        public static void GetConfigData()
        {
            ...
            try
            {
                try
                {
                    ...
                    if (System.IO.File.Exists(baseDirectory + "\\ss.dat"))
                    {
                        using (System.IO.StreamReader streamReader = new System.IO.StreamReader(baseDirectory + "\\ss.dat"))
                        {
                            ...
                            //baSubStore storeSubStoreDataBusniess =new baSubStore ();//baSubStore.GetSubstoreNameById(LoginUser.SubStoreId);
                            //LoginUser.SubstoreName = storeSubStoreDataBusniess.GetSubstoreNameById(System.Convert.ToInt32(text3.Split(new char[]
                            LoginUser.SubstoreName = baSubStore.GetSubstoreNameById(System.Convert.ToInt32(text3.Split(new char[]
							{
								','
							})[0]));
               ...
               // ConfigurationInfo configurationData = configBusiness.GetConfigurationData(LoginUser.SubStoreId);
                baConfigurationInfo configurationData = baConfigurationInfo.GetConfigurationData(LoginUser.SubStoreId);
                if (configurationData != null)
                {
                    LoginUser.DigiFolderBackGroundPath = configurationData.PS_BG_Path;
                    LoginUser.DigiFolderFramePath = configurationData.PS_Frame_Path;
                    LoginUser.DigiFolderPath = configurationData.PS_Hot_Folder_Path;
                    LoginUser.ModPassword = configurationData.PS_Mod_Password;
                    LoginUser.DigiFolderGraphicsPath = configurationData.PS_Graphics_Path;
                    LoginUser.DigiImagesCount = System.Convert.ToInt32(configurationData.PS_NoOfPhotos);
                    LoginUser.IsWatermark = configurationData.PS_Watermark;
                    LoginUser.IsHighResolution = configurationData.PS_HighResolution;
                    LoginUser.IsSemiOrder = configurationData.PS_SemiOrderMain;
                    LoginUser.DigiFolderBigThumbnailPath = configurationData.PS_Hot_Folder_Path + "Thumbnails_Big\\";
                    LoginUser.DigiFolderCropedPath = configurationData.PS_Hot_Folder_Path + "Croped\\";
                    LoginUser.DigiFolderThumbnailPath = configurationData.PS_Hot_Folder_Path + "Thumbnails\\";
                    LoginUser.DigiFolderAudioPath = configurationData.PS_Hot_Folder_Path + "Audio\\";
                    LoginUser.DigiFolderVideoTemplatePath = configurationData.PS_Hot_Folder_Path + "VideoTemplate\\";
                    LoginUser.DigiFolderVideoBackGroundPath = configurationData.PS_Hot_Folder_Path + "VideoBackGround\\";
                    LoginUser.DigiFolderProcessedVideosPath = configurationData.PS_Hot_Folder_Path + "ProcessedVideos\\";
                    LoginUser.DigiFolderVideoOverlayPath = configurationData.PS_Hot_Folder_Path + "VideoOverlay\\";
                    LoginUser.IsDiscountAllowed = configurationData.PS_AllowDiscount;
                    LoginUser.IsDiscountAllowedonTotal = configurationData.PS_EnableDiscountOnTotal;
                    LoginUser.DGNoOfPhotoIdSearch = configurationData.PS_NoOfPhotoIdSearch.Value;
                    LoginUser.PageCountGrid = configurationData.PS_PageCountGrid.Value;
                    LoginUser.DigiReportPath = configurationData.PS_Hot_Folder_Path + "Reports\\";
                    LoginUser.ItemTemplatePath = configurationData.PS_Hot_Folder_Path + "ItemTemplate\\";
                    LoginUser.ItemCalenderPath = configurationData.PS_Hot_Folder_Path + "ItemTemplate\\Calendar\\";
                    LoginUser.PhotoSWGeneralBackGroundPath = configurationData.PS_Hot_Folder_Path + "GeneralBG\\";
                    ...
                    System.Collections.Generic.List<SemiOrderSettings> lstSemiOrderSettings = semiOrderBusiness.GetLstSemiOrderSettings(null);
